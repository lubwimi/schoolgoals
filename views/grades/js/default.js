$(function() {
   ...
   $.get('grades/xhrGetlistings', function(o) {
      ...
      $('body').on('click', '.del', function() { //.del means class del. body means parent.
       delItem = $(this);
        ...
        $.post('grades/xhrDeleteListing', {'id': id}, function(o) { // function(o) is a callback function; {'id': id} is a json object and 'id' is the key
